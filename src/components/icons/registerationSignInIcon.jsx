const RegistrationSignInIcon = ({ className = "w-6 h-6", ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor" // این باعث می‌شود رنگ از Tailwind گرفته شود
      className={className}
      {...props}
    >
      {/* path برای یک آیکون استاندارد ورود/کاربر */}
      <path
        fillRule="evenodd"
...
export default RegistrationSignInIcon;
