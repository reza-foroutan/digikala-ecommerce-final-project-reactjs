const DesktopHeaderNavigationShopComponent = () => {
  return (
    <>
      <div className="header-navigation-shop w-[593px] h-10 relative flex justify-start items-center before:w-px before:bg-neutral-200 before:top-2.5 before:absolute before:right-4 before:h-5">
        {/* <!-- item 01 --> */}
        <div className="nav-item w-fit px-3 box-border h-full flex justify-center items-center">
          <a
            href="/"
            target="_self"
          ...
          >
            <div className="nav-item-svg ml-1">
              <svg
                className="w-[18px] h-[18px] fill-icon-high-emphasis align-middle"
                id="amazing"
        ...
        <div className="nav-item w-fit px-3 box-border h-full flex justify-center items-center">
          ...
          >
            <div className="nav-item-svg ml-1">
              <svg className="w-[18px] h-[18px] fill-icon-high-emphasis align-middle">
...
export default DesktopHeaderNavigationShopComponent;
